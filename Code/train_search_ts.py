...
def test():
  ...
  test_data = COVIDxDataset(mode='train', data_path=args.data)
  test_queue = DataLoader(test_data, batch_size=args.batch_size, shuffle=False, pin_memory=False, num_workers=2)
